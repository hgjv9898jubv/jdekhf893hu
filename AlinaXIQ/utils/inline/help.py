...
def first_page(_):
	...
	first_page_menu = InlineKeyboardMarkup(
		[
            ...
            [InlineKeyboardButton(text=_["H_B_11"], callback_data="help_callback hb11"), InlineKeyboardButton(text=_["H_B_23"], callback_data="help_callback hb23")],
			controll_button,
		]
	)
...
def second_page(_):
	...
	second_page_menu = InlineKeyboardMarkup(
		[
            ...
            [InlineKeyboardButton(text=_["H_B_21"], callback_data="help_callback hb21"), InlineKeyboardButton(text=_["H_B_24"], callback_data="help_callback hb24")],
			controll_button,
		]
	)
